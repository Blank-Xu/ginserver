...
// RespOk 200
// for GET
func (p *Context) RespOk(data interface{}) {
	if data == nil {
...
// RespCreated 201
// for POST/PUT/PATCH
func (p *Context) RespCreated(data interface{}) {
	if data == nil {
...
// RespAccepted  202
// for sync task
func (p *Context) RespAccepted() {
	p.AbortWithStatus(http.StatusAccepted)
}

// RespNoContent 204
// for DELETE
func (p *Context) RespNoContent() {
...
func (p *Context) Log(lType models.LogType, level models.LogLevel, remark ...string) {
